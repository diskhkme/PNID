...
# train_annotation_data, _ = segment_images_in_dataset(train_xmls, drawing_folder, drawing_segment_folder, segment_params, text_xml_folder, include_text_as_class, merge=merge_symbols_direction)
# val_annotation_data, _ = segment_images_in_dataset(val_xmls, drawing_folder, drawing_segment_folder, segment_params, text_xml_folder, include_text_as_class, merge=merge_symbols_direction)
test_annotation_data, ground_truth = segment_images_in_dataset(test_xmls, drawing_folder, drawing_segment_folder, segment_params, text_xml_folder, include_text_as_class, merge=merge_symbols_direction)
...
with open("test_img_dict.pkl", "wb") as f:
    pickle.dump(test_img_dict, f)

with open("ground_truth.pkl", "wb") as f:
    pickle.dump(ground_truth,f)

with open("symbol_dict.pkl", "wb") as f:
